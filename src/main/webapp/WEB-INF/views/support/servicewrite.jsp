   ...
   <style>
      * {
      ...
      .button {
         ...
         /* inline-block으로 버튼들이 가로로 정렬될 수 있도록 */
      }
...
<body>
   ...
   <div class="container">
      ...
      <div class="navi">${member.name}님 환영합니다</div>
      <div class="body">
         <h1>Q&A 작성하기</h1>
         <form action="/service/member/qna/add.do" method="post">
